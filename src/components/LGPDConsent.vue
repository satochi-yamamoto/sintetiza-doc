        ...
        <div class="mt-3">
          ...
          <div class="max-h-96 overflow-y-auto text-sm text-gray-700">
            <div v-if="locale === 'pt-BR'">
              <h4 class="font-semibold mb-2">1. Coleta de Dados</h4>
              <p class="mb-4">
              ...
              <h4 class="font-semibold mb-2">4. Seus Direitos (LGPD)</h4>
              <p class="mb-4">
              ...
              <h4 class="font-semibold mb-2">5. Segurança</h4>
              <p class="mb-4">
            ...
            <div v-else>
              <h4 class="font-semibold mb-2">1. Data Collection</h4>
              <p class="mb-4">
