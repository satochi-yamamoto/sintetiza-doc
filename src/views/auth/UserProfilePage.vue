    ...
    <div class="max-w-4xl mx-auto">
      <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
          ...
          <div
            v-if="error"
            class="mt-4 rounded-md bg-red-50 p-3 text-sm text-red-700 border border-red-200"
          >
            {{ error }}
          </div>
          <div
            v-if="info"
            class="mt-2 rounded-md bg-blue-50 p-3 text-sm text-blue-700 border border-blue-200"
          >
            {{ info }}
          </div>
        </div>
