    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-gray-600 mt-2">
              Análise detalhada de uso e performance da plataforma
            </p>
          </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div class="mt-4">
            <div class="flex items-center text-sm">
              <span
                :class="metrics.activeUsersChange >= 0 ? 'text-green-600' : 'text-red-600'"
                class="font-medium"
              >
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div class="mt-4">
            <div class="flex items-center text-sm">
              <span
                :class="metrics.documentsChange >= 0 ? 'text-green-600' : 'text-red-600'"
                class="font-medium"
              >
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div class="mt-4">
            <div class="flex items-center text-sm">
              <span
                :class="metrics.revenueChange >= 0 ? 'text-green-600' : 'text-red-600'"
                class="font-medium"
              >
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div class="mt-4">
            <div class="flex items-center text-sm">
              <span
                :class="metrics.conversionChange >= 0 ? 'text-green-600' : 'text-red-600'"
                class="font-medium"
              >
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div class="h-64 flex items-center justify-center bg-gray-50 rounded-lg">
            <p class="text-gray-500">
              Gráfico de crescimento de usuários (implementar com Chart.js)
            </p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div class="h-64 flex items-center justify-center bg-gray-50 rounded-lg">
            <p class="text-gray-500">
              Gráfico de processamento de documentos (implementar com Chart.js)
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div class="h-64 flex items-center justify-center bg-gray-50 rounded-lg">
            <p class="text-gray-500">
              Gráfico de distribuição de planos (implementar com Chart.js)
            </p>
          </div>
        </div>
      </div>
